...
//import gauravdahale.gtech.akoladirectory.activity.NotificationActivity
//import gauravdahale.gtech.akoladirectory.activity.PromoActivity
...
//                val intent = Intent(App.getContext(), RecordActivity::class.java)
//
...
//                Log.i("OneSignalExample", "customkey set with value: $n")
//                val intent = Intent(App.getContext(), PromoActivity::class.java)
//
//                intent.putExtra("url", i)
//
//                intent.putExtra("desc", d)
...
//                App.getContext().startActivity(intent)
//            } else {
//                val intent = Intent(App.getContext(), MainActivityTabVersion::class.java)
//                intent.flags =
...
//                    "https://play.google.com/store/apps/details?id=gauravdahale.gtech.akoladirectory "
//                )
//                share.putExtra(
...
//                )
//
//                App.getContext().startActivity(Intent.createChooser(share, "Akola Directory"))
//            } else if (result.action.actionID == "ActionTwo") {
//                Toast.makeText(App.getContext(), "ActionTwo Button was pressed", Toast.LENGTH_LONG)
//                    .show()
//            }
//        }
//    }
