...
public class AutomobilesFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = (new FirebaseRecyclerAdapter<ContactModel, ItemViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull ItemViewHolder viewHolder, int position, @NonNull final ContactModel items) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_automobiles, container, false);

        mRecyclerView = (RecyclerView) v.findViewById(R.id.automobiles_recycler);
